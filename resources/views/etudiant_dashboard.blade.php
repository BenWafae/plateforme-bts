...
@section('content')
    ...
    {{-- Filtres : Année, Filière, Matière, Type --}}
    <div class="container-fluid py-3 mb-4" style="background-color: rgb(8, 45, 82); border-radius: 10px;">
        <div class="d-flex flex-wrap align-items-center justify-content-center gap-3">
            ...
            <form method="GET" action="{{ route('etudiant.dashboard') }}" class="d-inline-block">
                <select name="annee" class="form-select" onchange="this.form.submit()" style="width: auto; padding: 8px; font-weight: bold;">
            ...
            @if(request('annee'))
                <div class="dropdown">
                    <button class="btn btn-outline-light dropdown-toggle px-4 py-2 fw-bold" type="button" id="filiereDropdown" data-bs-toggle="dropdown">
                        Filière
                    </button>
            ...
            @if(request('filiere_id'))
                <div class="dropdown">
                    <button class="btn btn-outline-light dropdown-toggle px-4 py-2 fw-bold" type="button" id="matiereDropdown" data-bs-toggle="dropdown">
                        Matière
                    </button>
                    <ul class="dropdown-menu">
            ...
            {{-- Dropdown Type de support --}}
            @if(request('matiere_id'))
                <div class="dropdown">
                    <button class="btn btn-outline-light dropdown-toggle px-4 py-2 fw-bold" type="button" id="typeDropdown" data-bs-toggle="dropdown">
                        Type de support
                    </button>
                    <ul class="dropdown-menu">
