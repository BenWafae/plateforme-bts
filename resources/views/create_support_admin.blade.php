...
<div class="container-fluid mt-4">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-card">
                <form action="{{ route('admin.support.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                    @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <select name="format" 
                                        ...
                                        <option value="ppt">
                                            <i class="fas fa-file-powerpoint"></i> Présentation PPT
                                        </option>
                                        <option value="word">
                                            <i class="fas fa-file-word"></i> Document Word
                                        </option>
                                        <option value="lien_video">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label for="id_user" class="form-label-modern">
...
function filterProfesseurs() {
    ...
    if (selectedMatiereId === "") {
        ...
        let filtered = professeurs.filter(prof => {
            return prof.matieres && prof.matieres.some(m => m.id_Matiere == selectedMatiereId);
        });
